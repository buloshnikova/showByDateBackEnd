...
export function show(req, res) {
  return Performer.findById(req.params.id).exec()
...
export function create(req, res) {
  return Performer.create(req.body)
...
export function upsert(req, res) {
  ...
  return Performer.findOneAndUpdate(req.params.id, req.body, {upsert: true, setDefaultsOnInsert: true, runValidators: true}).exec()
